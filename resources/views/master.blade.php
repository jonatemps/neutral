        ...
        <div class="a8 a1K ab[-16px]">
            ...
            <div class="a21 aB[360px]">
              ...
              <div class="a8 a9">
                <a
                  ...
                  class="a24[#CED3F6] hover:a1W a25"
                >
                  <svg
                    width="9"
                    height="18"
          ...
          <div class="a7 md:a1_/2 lg:a20/12 xl:a28/12 ae">
            <div class="a21">
              ...
              "
            >
            Tenez-vous informé des dernières mise à jours
            </p>
              <form>
                <input
                    type="email"
      ...
      <div class="ai a1k a29">
        <div class="aa">
          <p
            ...
            "
          >
            &copy; Propulsé par: "studio Convave"
          </p>
        </div>
      </div>
